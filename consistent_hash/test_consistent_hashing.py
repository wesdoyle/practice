...
def test_same_key_maps_to_same_node():
    ring = ConsistentHashRing(nodes=["node1", "node2", "node3"], virtual_nodes=50, replication_factor=1)
    key = "persistent-key"
...
def test_get_multiple_replicas_for_key():
    ring = ConsistentHashRing(nodes=["n1", "n2", "n3", "n4"], virtual_nodes=100, replication_factor=2)
    key = "resilient_key"
...
def test_removing_node_reassigns_keys():
    ring = ConsistentHashRing(nodes=["a", "b", "c"], virtual_nodes=100, replication_factor=2)
    key = "some_key"
...
def test_all_nodes_receive_some_keys():
    ring = ConsistentHashRing(nodes=["a", "b", "c"], virtual_nodes=100, replication_factor=1)
